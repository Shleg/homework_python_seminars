...
# ноутбук
# 12
def get_word_cost(word: str, some_dict: dict) -> int:
    cost = 0
    for sym in word:
...
word_cost = get_word_cost(my_word, dict_eng) + get_word_cost(my_word, dict_rus)

print(f"Ценность слова '{my_word}' равна {word_cost}")
